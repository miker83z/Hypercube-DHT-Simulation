...
with open("./resultS7.csv", newline="", encoding="ISO-8859-1") as filecsv:
...
plt.title('Ricerca SUPER SET SEARCH - Dimensione Ipercubo: 8192 - Oggetti restituiti: 10', size=18)
