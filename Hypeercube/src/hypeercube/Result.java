...
public class Result {
	...
	public String filePathS = "resultS.csv";
	...
	/**Metodo SUPER SET search */
	public void printResultS(ArrayList<String> exchange) {

		try {
			
		FileWriter fw = new FileWriter(filePathS, true);
		BufferedWriter bf = new BufferedWriter(fw);
		PrintWriter pw = new PrintWriter(bf);
